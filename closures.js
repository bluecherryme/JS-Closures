...
function findPotentialFriends(existingFriends) {
    ...
    return function(name){
      return (existingFriends.indexOf(name) === -1) ? true : false
    }
...
var potentialSecondLevelFriends = secondLevelFriends.filter(curr => isNotAFriend(curr));
var allPotentialFriends = allUsers.filter(curr => isNotAFriend(curr));
